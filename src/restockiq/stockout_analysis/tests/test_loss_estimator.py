...
class TestStockoutLossEstimator:
    def test_revenue_lost_is_correctly_computed(self, high_severity_event: StockoutEvent) -> None:
    ...
    def test_margin_lost_is_correctly_computed(self, high_severity_event: StockoutEvent) -> None:
        estimate = estimate_loss(
            event=high_severity_event,
            sell_price=Money(Decimal("25"), "ETB"),
            cost_price=Money(Decimal("20"), "ETB"),
    ...
    def test_severity_is_forwarded_from_event(self, high_severity_event: StockoutEvent) -> None:
        estimate = estimate_loss(
            event=high_severity_event,
            sell_price=Money(Decimal("25"), "ETB"),
            cost_price=Money(Decimal("20"), "ETB"),
